...
| 021  | Replace off-main-thread NSFontManager with descriptor traits | P1 | S | — | TODO |
| 022  | Harden the captured-HTML sanitizer (charset + SVG/background) | P2 | S–M | 021 (soft) | TODO |
| 023  | Search matches attachment filenames | P2 | S | — | TODO |
| 024  | Cut per-row/per-render O(N) rebuilds in the note list | P2 | M | 023 (soft) | TODO |
| 025  | Update check: honest no-releases case + tested comparator | P3 | S | — | TODO |
